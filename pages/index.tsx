				...
				<div className='grid grid-rows-2 gap-8 | md:grid-rows-1 md:grid-cols-2 md:gap-[5vw] | lg:gap-24'>
					...
					<div className='flex flex-col justify-center items-center gap-6 text-center | md:text-left md:items-start'>
						...
						<p className='text-white leading-relaxed max-w-[40ch]'>
							...
							maiores tenetur! Rerum, exercitationem in cumque dignissimos sed quam
							eum error corrupti animi consectetur totam quas, placeat doloribus
							nesciunt ea dolore libero incidunt eligendi. Quisquam beatae saepe nulla
							distinctio illum labore, corporis assumenda.
						</p>
						<p className='text-white leading-relaxed max-w-[40ch]'>
							Lorem ipsum dolor, sit amet consectetur adipisicing elit. Non architecto
							quasi eveniet accusantium repellendus odit officiis porro hic est
							adipisci.
						</p>
