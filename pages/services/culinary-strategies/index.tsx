...
export default function CulinaryStrategies() {
	...
	return (
		<motion.main key='services-culinary' {...fadeInOut}>
			...
			<section className='flex flex-col gap-y-24 bg-lightmandarin px-[10%] pt-16 text-white | md:pb-16 md:pt-56 md:gap-y-4 md:-mb-96 | lg:gap-y-8 | xl:pt-80 xl:mb-[-36rem]'>
				<SubSection
